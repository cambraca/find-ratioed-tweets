...
func search(token, query string) {
	...
	fieldOpts := twitter.TweetFieldOptions{
		TweetFields: []twitter.TweetField{twitter.TweetFieldCreatedAt, twitter.TweetFieldConversationID, twitter.TweetFieldAuthorID, twitter.TweetFieldPublicMetrics},
